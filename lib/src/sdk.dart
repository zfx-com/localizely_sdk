...
class Localizely {
  ...
  static Future<TranslationsUpdateResult> updateTranslations() async {
    ...
    if (SdkData.metadata == null) {
      throw SdkException(
          "Metadata configuration has not been set. Please ensure 'ota_enabled' is set to 'true' within 'flutter_intl/localizely' section of the 'pubspec.yaml' file, and that 'updateTranslations' method is called after localization delegates initialization.");
    }
    ...
    var sdkBuildNumber = Util.getSdkBuildNumber();

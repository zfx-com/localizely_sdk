import 'package:localizely_sdk/src/api/api_exception.dart';
...
class LabelsService {
  ...
  static Future<int> getLabels(
    ...
    try {
      var bundleInfo = await Api.getBundleInfo(sdkToken, distributionId,
          currentLocale, appInstallationId, sdkBuildNumber, appBuildNumber,
      ...
      if (bundleInfo.version != releaseVersion) {
        ...
        var releaseData =
            ReleaseData(version: bundleInfo.version, data: bundleData.data);
